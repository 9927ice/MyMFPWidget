...
window.WLJSX.Ajax.WLRequest = WLJSX.Class.create({
  ...
  onFailure: function (transport) {
    ...
    if (transport.status !== '510' && transport.responseJSON !== '' && transport.responseJSON.errorCode !== WL.ErrorCode.REQUEST_TIMEOUT && transport.responseJSON.errorCode !== WL.ErrorCode.UNRESPONSIVE_HOST) {
      WLJSX.Ajax.WLRequest.setConnected(true);
    }
