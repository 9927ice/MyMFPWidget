...
- (BOOL)application:(UIApplication*)application didFinishLaunchingWithOptions:(NSDictionary*)launchOptions
{
    ...
    [[NSNotificationCenter defaultCenter]addObserverForName:MFP_INITIALIAZATION object:nil queue:nil usingBlock:^(NSNotification * note) {
  ...
  sourceApplication:(NSString *)sourceApplication annotation:(id)annotation
{
    ...
    UILabel *myLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, 100, [[UIScreen mainScreen] bounds].size.width, 80)];

    [myLabel setText:[url scheme]];
    myLabel.textAlignment = NSTextAlignmentCenter;
    
    [self.viewController.view addSubview:myLabel];
...
- (void)connectSrv {
    ...
    WLResourceRequest *request = [WLResourceRequest requestWithURL:[NSURL URLWithString:@"/adapters/httpAdapter/unprotected/"] method:WLHttpMethodGet];
